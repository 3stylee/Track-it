...
const mapStateToProps = (state: State) => {
	...
	const initialLoadError = state.apiError === ACTIVITIES_LIST_ERRORS.ATHLETE_ACTIVITIES_ERROR
	const loadMoreError = state.apiError === ACTIVITIES_LIST_ERRORS.LOAD_MORE_ACTIVITIES_ERROR
	return {
